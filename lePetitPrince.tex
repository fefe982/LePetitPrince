...
\renewcommand{\chaptername}{Le Chaptier}
\renewcommand{\thechapter}{\Roman{chapter}}
\usepackage{titlesec}
\titleformat{\chapter}{\normalfont\Huge\bfseries}{Le Chaptire\  \thechapter}{20pt}{\Huge}
...
\newcommand{\maincol}{\switchcolumn[0]*\enablehyphenation}

\newcommand{\ipacol}{\switchcolumn[1]\disablehyphenation}
...
\ipacol
ʒə dəmɑ̃d paʁdɔ̃ oz- ɑ̃fɑ̃ davwaʁ dedje sə livʁ a yn ɡʁɑ̃d pɛʁsɔn. ʒe yn ɛkskyz seʁjøːz: sɛt ɡʁɑ̃d pɛʁsɔn ɛ lə mɛjœʁ ami kə ʒe o mɔ̃ːd. ʒe yn otʁ ɛkskyːz: sɛt ɡʁɑ̃d pɛʁsɔn pø tu kɔ̃pʁɑ̃ːdʁ, mɛm le livʁə puʁ ɑ̃fɑ̃. ʒe yn tʁwazjɛm ɛkskyːz: sɛt ɡʁɑ̃d pɛʁsɔn abit la fʁɑ̃s u ɛl a fɛ̃ e fʁwa. ɛl a bəzwɛ̃ dɛtʁə kɔ̃sɔle. si tut sez- ɛkskyz nə syfiz pa, ʒə vø bjɛ̃ dedje sə livʁ a lɑ̃fɑ̃ ka ete otʁəfwa sɛt ɡʁɑ̃d pɛʁsɔn. tut le ɡʁɑ̃d pɛʁsɔn ɔ̃ dabɔʁ ete dez- ɑ̃fɑ̃. (mɛ pø dɑ̃tʁ ɛl sɑ̃ suvjɛn). ʒə kɔʁiʒ dɔ̃k ma dedikas:
\maincol
\begin{quote}
    \centering
    A Léon Werth
...
\ipacol
lɔʁskə ʒavɛ siz ɑ̃ ʒe vy, yn fwa, yn maɲifik imaːʒ, dɑ̃ ɛ̃ livʁə syʁ la fɔʁɛ vjɛʁʒ ki saplɛ «~istwaʁ veky~». sa ʁəpʁezɑ̃tɛ ɛ̃ sɛʁpɑ̃ bɔa ki avalɛ ɛ̃ foːv. vwala la kɔpi dy desɛ̃.
\maincol
...
\ipacol
ɔ̃ dizɛ dɑ̃ lə liːvʁ: «~le sɛʁpɑ̃ bɔa aval lœʁ pʁwa tu ɑ̃tjɛːʁ, sɑ̃ la maʃe. ɑ̃sɥit il nə pœv ply buʒe e il dɔʁm pɑ̃dɑ̃ le si mwa də lœʁ diʒɛstjɔ̃~».
\maincol
J'ai alors beaucoup réfléchi sur les aventures de la jungle et, à mon tour, j'ai réussi, avec un crayon de couleur, à tracer mon premier dessin. Mon dessin numéro 1. Il était comme ça:
\ipacol
ʒe alɔʁ boku ʁefleʃi syʁ lez- avɑ̃tyʁ də la ʒɛ̃ɡl e, a mɔ̃ tuːʁ, ʒe ʁeysi, avɛk ɛ̃ kʁɛjɔ̃ də kulœːʁ, a tʁase mɔ̃ pʁəmje desɛ̃. mɔ̃ desɛ̃ nymeʁo ɛ̃. il etɛ kɔm sa:
\maincol
\incpic{pic/image2.png}
\maincol
J'ai montré\ft[montrer]{v.t.}{to show} mon chef d'œuvre aux grandes personnes et je leur ai demandé si mon dessin leur faisait\ft[faire]{Impar.}{} peur.
\ipacol
ʒe mɔ̃tʁe mɔ̃ ʃɛf dœvʁ o ɡʁɑ̃d pɛʁsɔn e ʒə lœʁ e dəmɑ̃de si mɔ̃ desɛ̃ lœʁ fəzɛ pœːʁ.
\maincol
Elles m'ont répondu: «~Pourquoi un chapeau ferait-il peur?~»
\ipacol
ɛl mɔ̃ ʁepɔ̃dy: «~puʁkwa ɛ̃ ʃapo fəʁɛ-til pœːʁ?~»
\maincol
...
\ipacol
mɔ̃ desɛ̃ nə ʁəpʁezɑ̃tɛ pa ɛ̃ ʃapo. il ʁəpʁezɑ̃tɛ ɛ̃ sɛʁpɑ̃ bɔa ki diʒeʁɛ ɛ̃n- elefɑ̃. ʒe alɔʁ desine lɛ̃teʁjœʁ dy sɛʁpɑ̃ bɔa, afɛ̃ kə le ɡʁɑ̃d pɛʁsɔn pɥis kɔ̃pʁɑ̃ːdʁ. ɛlz- ɔ̃ tuʒuʁ bəzwɛ̃ dɛksplikasjɔ̃. mɔ̃ desɛ̃ nymeʁo dø etɛ kɔm sa:
\maincol
\incpic{pic/image3.png}
\maincol
Les grandes personnes m'ont conseillé\ft[conseiller]{v.t.}{to advise} de laisser de côté\ft[laiser qch. de côté]{}{to put something aside} les dessins de serpents boas ouverts ou fermés, et de m'intéresser\ft[se intéresser à]{v.pr.plus.prép}{to be interested in} plutôt\ft{adv.}{rather, instead} à la géographie, à l'histoire, au calcul et à la grammaire. C'est ainsi que j'ai abandonné, à l'âge de six ans, une magnifique carrière de peintre. J'avais été découragé par l'insuccès de mon dessin numéro 1 et de mon dessin numéro 2. Les grandes personnes ne comprennent jamais rien toutes seules, et c'est fatigant\ft{adj.}{tiring}, pour les enfants, de toujours leur donner des explications.
\ipacol
le ɡʁɑ̃d pɛʁsɔn mɔ̃ kɔ̃seje də lese də kote le desɛ̃ də sɛʁpɑ̃ bɔa uvɛʁ u fɛʁme, e də mɛ̃teʁese plyto a la ʒeɔɡʁafi, a listwaːʁ, o kalkyl e a la ɡʁamɛːʁ. sɛt- ɛ̃si kə ʒe abɑ̃dɔne, a laʒ də siz ɑ̃, yn maɲifik kaʁjɛʁ də pɛ̃tʁ. ʒavɛ ete dekuʁaʒe paʁ lɛ̃syksɛ də mɔ̃ desɛ̃ nymeʁo ɛ̃ e də mɔ̃ desɛ̃ nymeʁo dø. le ɡʁɑ̃d pɛʁsɔn nə kɔ̃pʁɛn ʒamɛ ʁjɛ̃ tut sœːl, e sɛ fatiɡɑ̃, puʁ lez- ɑ̃fɑ̃, də tuʒuʁ lœʁ dɔne dez- ɛksplikasjɔ̃.
\maincol
J'ai donc dû\ft[devoir]{v.aux. Past.pas.}{has to, ought to, ...} choisir\ft{v.t.}{to choose} un autre métier\ft{n.m.}{job occupation} et j'ai appris\ft[apprendre]{v.t. Part.pas.}{learn} à piloter des avions. J'ai volé\ft[voler]{v.i. Part.pas.}{to fly} un peu\ft[un peu]{}{a little, a bit} partout\ft{adv.}{everywhere} dans le monde. Et la géographie, c'est exact, m'a beaucoup servi. Je savais\ft[ savoir]{v.t. Impar.}{to know how to, to be able to} reconnaître\ft{v.t.}{to recognize}, du premier coup d'œil\ft[coup d’œil]{n.m.}{look, glance}, la Chine de l'Arizona. C'est utile\ft{adj.}{useful}, si l'on est égaré\ft[égarer]{v.t.}{to lose, to mislead} pendant la nuit.
\ipacol
ʒe dɔ̃k dy ʃwaziʁ ɛ̃n- otʁə metje e ʒe apʁi a pilɔte dez- avjɔ̃. ʒe vɔle ɛ̃ pø paʁtu dɑ̃ lə mɔ̃ːd. e la ʒeɔɡʁafi, sɛt- ɛɡzakt, ma boku sɛʁvi. ʒə savɛ ʁəkɔnɛtʁ, dy pʁəmje ku dœːj, la ʃin də laʁizɔna. sɛt- ytil, si lɔ̃n- ɛ eɡaʁe pɑ̃dɑ̃ la nɥi.
\maincol
J'ai ansi eu, au cours\ft[]{m.n}{course} de ma vie, des tas de\ft[un tas de]{}{loads of} contacts avec des tas de gens sérieux. J'ai beaucoup vécu chez les grandes personnes. Je les ai vues de très près. Ça n'a pas trop amélioré mon opinion.
\ipacol
ʒe ɑ̃si y, o kuʁ də ma vi, de ta də kɔ̃takt avɛk de ta də ʒɑ̃ seʁjø. ʒe boku veky ʃe le ɡʁɑ̃d pɛʁsɔn. ʒə lez- e vy də tʁɛ pʁɛ. sa na pa tʁo ameljɔʁe mɔ̃n- ɔpinjɔ̃.
\maincol
Quand j'en rencontrais\ft[rencontrer]{v.t. Impar.}{to meet} une qui me paraissait un peu lucide\ft[adj.]{lucid, clear headed}, je faisait l'expérience sur elle de mon dessin no.~1 que j'ai toujours conservé. Je voulais\ft[vouloir faire qch.]{v.t. Impar.}{to want to do sth.} savoir si elle était vraiment compréhensive. Mais toujours elle me répondait: «~C'est un chapeau.~» Alors je ne lui parlais ni de serpents boas, ni de forêts vierges, ni d'étoiles\ft{n.m.}{star}. Je me mettais\ft[mettre]{v.t. Impar.}{to put} à sa portée\ft{n.m.}{range, scope}. Je lui parlais de bridge, de golf, de politique et de cravates\ft{n.m.}{tie}. Et la grande personne était bien contente de connaître un homme aussi raisonnable.
\ipacol
kɑ̃ ʒɑ̃ ʁɑ̃kɔ̃tʁɛ yn ki mə paʁɛsɛ ɛ̃ pø lysid, ʒə fəzɛ lɛkspeʁjɑ̃s syʁ ɛl də mɔ̃ desɛ̃ nymero ɛ̃ kə ʒe tuʒuʁ kɔ̃sɛʁve. ʒə vulɛ savwaʁ si ɛl etɛ vʁɛmɑ̃ kɔ̃pʁeɑ̃siːv. mɛ tuʒuʁ ɛl mə ʁepɔ̃dɛ: «~sɛt- ɛ̃ ʃapo.~» alɔʁ ʒə nə lɥi paʁlɛ ni də sɛʁpɑ̃ bɔa, ni də fɔʁɛ vjɛːʁʒ, ni detwal. ʒə mə mɛtɛ a sa pɔʁte. ʒə lɥi paʁlɛ də bʁidʒ, də ɡɔlf, də pɔlitik e də kʁavat. e la ɡʁɑ̃d pɛʁsɔn etɛ bjɛ̃ kɔ̃tɑ̃t də kɔnɛtʁ ɛ̃n- ɔm osi ʁɛzɔnabl.
\maincol
...
\ipacol
ʒe ɛ̃si veky sœːl, sɑ̃ pɛʁsɔn avɛk ki paʁle veʁitabləmɑ̃, ʒyska yn pan dɑ̃ lə dezɛʁ dy saaʁa, il j- a siz ɑ̃. kɛlkə ʃoz setɛ kase dɑ̃ mɔ̃ mɔtœːʁ, e kɔm ʒə navɛ avɛk mwa ni meʃanisjɛ̃, ni pasaʒe, ʒə mə pʁepaʁe a eseje də ʁeysiːʁ, tu sœːl, yn ʁepaʁasjɔ̃ difisil. setɛ puʁ mwa yn kɛstjɔ̃ də vi u də mɔːʁ. ʒavɛ a pɛn də lo a bwaʁ puʁ ɥi ʒuːʁ.
\maincol
Le premier soir je me suis donc endormi sur le sable\ft{n.m.}{sand} à mille milles de toute terre habitée. J'étais bien plus isolé qu'un naufragé\ft[]{adj.}{shipwrecked} sur un rideau\ft{n.m.}{curtain, hanging, rag} au milieu\ft{n.m.}{center, middle} de l'océan. Alors vous imaginez ma surprise, au levé du jour\ft[le lever du jour]{}{day break, dawn}, quand une drôle\ft[]{adj.}{funny} de petite voix\ft{n.f.}{voice} m'a réveillé\ft[réveiller]{v.t.}{to wake up}. Elle disait:
\ipacol
lə pʁəmje swaʁ ʒə mə sɥi dɔ̃k ɑ̃dɔʁmi syʁ lə sabl a mil mil də tut tɛʁ abite. ʒetɛ bjɛ̃ ply izɔle kɛ̃ nofʁaʒe syʁ ɛ̃ ʁido o miljø də lɔseɑ̃. alɔʁ vuz- imaʒine ma syʁpʁiːz, o ləve dy ʒuːʁ, kɑ̃ yn dʁol də pətit vwa ma ʁeveje. ɛl dizɛ:
\maincol
-S'il vous plaît... dessine-moi un mouton!
\ipacol
-sil vu plɛ... desin-mwa ɛ̃ mutɔ̃!
\maincol
-Hein!
\ipacol
-ɛ̃!
...
-desin-mwa ɛ̃ mutɔ̃...
\maincol
J'ai sauté\ft[souter]{v.t.}{to jump, to spring up} sur mes pieds\ft{n.m.}{foot} comme si j'avais été frappé\ft[frapper]{n.t}{to hit, to strike} par la foudre\ft[]{n.m.}{thunderbolt}. J'ai bien frotté\ft[frotter]{v.t.}{to rub} mes yeux. J'ai bien regardé. Et j'ai vu un petit bonhomme tout à fait\ft[tout à fait]{loc.adv.}{quite, fully, absolutely} extraordinaire qui me considérait\ft[considérer]{v.t. Impar.}{to gaze, to stare at} gravement. Voilà le meilleur portrait que, plus tard, j'ai réussi à faire de lui. Mais mon dessin, bien sûr, est beaucoup moins ravissant\ft{adj.}{gorgeous, beautiful} que le modèle. Ce n'est pas de ma faute.
\ipacol
ʒe sote syʁ me pje kɔm si ʒavɛ ete fʁape paʁ la fudʁ. ʒe bjɛ̃ fʁɔte mez- jø. ʒe bjɛ̃ ʁəɡaʁde. e ʒe vy ɛ̃ pəti bɔnɔm tu a fɛ ɛkstʁaɔʁdinɛʁ ki mə kɔ̃sideʁɛ ɡʁavmɑ̃. vwala lə mɛjœʁ pɔʁtʁɛ kə, ply taːʁ, ʒe ʁeysi a fɛʁ də lɥi. mɛ mɔ̃ desɛ̃, bjɛ̃ syːʁ, ɛ boku mwɛ̃ ʁavisɑ̃ kə lə mɔdɛl. sə nɛ pa də ma foːt.
\maincol
...
\ipacol
ʒavɛ ete dekuʁaʒe dɑ̃ ma kaʁjɛʁ də pɛ̃tʁə paʁ le ɡʁɑ̃d pɛʁsɔn, a laʒ də siz ɑ̃, e ʒə navɛ ʁjɛ̃ apʁi a desine, sof le bɔa fɛʁme e le bɔa uvɛːʁ.
\maincol
\incpic{pic/image4.jpeg}
\maincol
Je regardai donc cette apparition\ft{n.f.}{arrivale, (first) appearance} avec des yeux tout ronds\ft{adj.}{round} d'étonnement\ft{n.m.}{surprise, astonishment}. N'oubliez\ft[oublier]{v.t. 2 p.p. Prés.}{to forget} pas que je me trouvais\ft[se trouver]{v.pr.i.}{to be, to be located} à mille milles de toute région habitée. Or mon petit bonhomme ne me semblait ni égaré\ft{adj.}{lost}, ni mort de fatigue, ni mort de faim, ni mort de soif\ft{n.f.}{thirst}, ni mort de peur\ft{n.f.}{fear}. Il n'avait en rien\ft[en rien]{lov.adv.}{nothing, not at all} l'apparence d'un enfant perdu\ft{adj.}{lost} au milieu du désert, à mille milles de toute région habitée. Quand je réussis enfin de parler, je lui dis:
\ipacol
ʒə ʁəɡaʁde dɔ̃k sɛt apaʁisjɔ̃ avɛk dez- jø tu ʁɔ̃ detɔnmɑ̃. nublije pa kə ʒə mə tʁuvɛ a mil mil də tut ʁeʒjɔ̃ abite. ɔʁ mɔ̃ pəti bɔnɔm nə mə sɑ̃blɛ ni eɡaʁe, ni mɔʁ də fatiɡ, ni mɔʁ də fɛ̃, ni mɔʁ də swaf, ni mɔʁ də pœːʁ. il navɛ ɑ̃ ʁjɛ̃ lapaʁɑ̃s dɛ̃n- ɑ̃fɑ̃ pɛʁdy o miljø dy dezɛːʁ, a mil mil də tut ʁeʒjɔ̃ abite. kɑ̃ ʒə ʁeysi ɑ̃fɛ̃ də paʁle, ʒə lɥi di:
\maincol
-Mais qu'est-ce que tu fais\ft[faire]{v. 2 p.p. Prés.}{} là?
\ipacol
-mɛ kɛ-s kə ty fɛ la?
\maincol
Et il me répéta alors, tout doucement\ft[ doucement]{adv.}{gently}, comme une chose très sérieuse:
\ipacol
e il mə ʁepeta alɔːʁ, tu dusmɑ̃, kɔm yn ʃoz tʁɛ seʁjøːz:
\maincol
-S'il vous plaît... dessine-moi un mouton...
\ipacol
-sil vu plɛ... desin-mwa ɛ̃ mutɔ̃...
\maincol
Quand le mystère est trop impressionnant\ft[impressionnant]{adj.}{impressive, stunning}, on n'ose\ft[oser fair qch.]{v.t. 3 p.p. Prés.}{to dare to do sth.} pas désobéir. Aussi absurde que cela me semblât à mille milles de tous les endroits\ft[endroit]{n.m.}{place} habités et en danger de mort, je sortis\ft[sortis]{v.t. 1 p.p. Pas.}{to take out} de ma poche une feuille\ft[feuille]{n.m.}{sheet} de papier et un stylographe. Mais je me rappelai\ft[se rappaler]{v.pr.t}{to remember} alors que j'avais surtout étudié la géographie, l'histoire, le calcul et la grammaire et je dis au petit bonhomme (avec un peu de mauvaise humeur) que je ne savais pas dessiner. Il me répondit:
\ipacol
kɑ̃ lə mistɛʁ ɛ tʁo ɛ̃pʁesjɔnɑ̃, ɔ̃ noz pa dezɔbeiːʁ. osi apsyʁdə kə səla mə sɑ̃bla a mil mil də tu lez- ɑ̃dʁwa abite e ɑ̃ dɑ̃ʒe də mɔːʁ, ʒə sɔʁti də ma pɔʃ yn fœj də papje e ɛ̃ stilɔɡʁaf. mɛ ʒə mə ʁaple alɔʁ kə ʒavɛ syʁtu etydje la ʒeɔɡʁafi, listwaːʁ, lə kalkyl e la ɡʁamɛʁ e ʒə di o pəti bɔnɔm (avɛk ɛ̃ pø də movɛz ymœːʁ) kə ʒə nə savɛ pa desine. il mə ʁepɔ̃di:
\maincol
-Ça ne fait rien. Dessine-moi un mouton.
\ipacol
-sa nə fɛ ʁjɛ̃. desin-mwa ɛ̃ mutɔ̃.
\maincol
Comme je n'avais jamais dessiné un mouton je refis\ft[refaire]{v.t. 1 p.p. Pas.}{to redo}, pour, un des deux seuls dessins dont\ft[dont]{pron.rel.}{whose, of which} j'étais capable. Celui du boa fermé. Et je fus stupéfait\ft[stupéfait]{adj.}{astounded, stunned, stupefied} d'entendre\ft[entendre]{v.t.}{to hear} le petit bonhomme me répondre:
\ipacol
kɔm ʒə navɛ ʒamɛ desine ɛ̃ mutɔ̃ ʒə ʁəfi, puːʁ, ɛ̃ de dø sœl desɛ̃ dɔ̃ ʒetɛ kapabl. səlɥi dy bɔa fɛʁme. e ʒə fy stypefɛ dɑ̃tɑ̃dʁə lə pəti bɔnɔm mə ʁepɔ̃ːdʁ:
\maincol
...
\ipacol
-nɔ̃! nɔ̃! ʒə nə vø pa dɛ̃n- elefɑ̃ dɑ̃ ɛ̃ bɔa. ɛ̃ bɔa sɛ tʁɛ dɑ̃ʒʁø, e ɛ̃n- elefɑ̃ sɛ tʁɛz- ɑ̃kɔ̃bʁɑ̃. ʃe mwa sɛ tu pəti. ʒe bəzwɛ̃ dɛ̃ mutɔ̃. desin-mwa ɛ̃ mutɔ̃.
\maincol
Alors j'ai dessiné.
\ipacol
alɔʁ ʒe desine.
...
-Celui-là est trop vieux\ft[vieux]{adj.}{old}. Je veux un mouton qui vive longtemps.
...
-Ca c'est la caisse\ft[caisse]{n.f.}{box, case, chest}. Le mouton que tu veux est dedans\ft[dedans]{adv.}{inside}.

Mais je fus bien surpris de voir s'illuminer\ft[illuminer]{v.pr.i}{to light up} le visage\ft[visage]{n.m.}{face} de mon jeune juge\ft[juge]{n.m.}{judge}:

-C'est tout à fait comme ça que je le voulais! Crois\ft[crois]{v.t. 2 p.s. Prés}{to believe}-tu qu'il faille\ft[falloir]{v.imp. 3 p.s. Prés.subj.}{[exprime le besoin]} beaucoup d'herbe à ce mouton?

-Pourquoi?

-Parce que chez moi c'est tout petit...

-Ca suffira\ft[suffire]{v.t. 3 p.s. Fut.}{to be enough, to be sufficient, to suffice} sûrement. Je t'ai donné un tout petit mouton.

Il pencha\ft[pencher]{v.t.}{to tilt, to tip up} la tête\ft[tête]{n.m.}{head} vers le dessin:
...
Il me fallut longtemps pour comprendre d'où il venait. Le petit prince, qui me posait\ft[poser]{v.t.}{to put, to lay, to place} beaucoup de questions, ne semblait jamais entendre\ft[entendre]{v.t.}{to hear} les miennes\ft[les miennes]{}{mine}. Ce sont des mots\ft[mot]{n.m.}{word} prononcés\ft[prononcé]{adj.}{pronounced, strongly marked} par hasard\ft[par hasard]{loc.adv.}{by chance, by accident} qui, peu à peu, m'ont tout révélé. Ainsi, quand il aperçu\ft[aperçu]{v.t.}{m.s. Part.pas. (apercevoir) to glimpse, to catch sight of} pour la première fois mon avion (je ne dessinerai pas mon avion, c'est un dessin beaucoup trop compliqué pour moi) il me demanda:

-Qu'est ce que c'est que cette chose-là?

-Ce n'est pas une chose. Ca vole\ft[voler]{v.i.}{to fly}. C'est un avion. C'est mon avion.

Et j'étais fier\ft[fier]{adj.}{proud} de lui apprendre que je volais. Alors il s'écria\ft[écrier]{v.pr.i.}{to cry, to shout, to exlaim}:

-Comment! tu es tombé\ft[tomber]{v.i.}{to fall (down), to fall over} du ciel!

-Oui, fis-je modestement\ft[modestement]{adv.}{modestly, simply}.

-Ah! ça c'est drôle...

Et le petit prince eut un très joli\ft[joli]{adj.}{pretty, lovely, nice} éclat de rire\ft[éclat de rire]{burst}{or roar of laughter} qui m'irrita beaucoup. Je désire que l'on prenne mes malheurs\ft[malheurs]{n.m.}{misfortune} au sérieux. Puis il ajouta\ft[ajouter]{v.t.}{to add}:

-Alors, toi aussi tu viens du ciel! De quelle planète es-tu?

J'entrevis\ft[entrevoir]{v.t. 1 p.s. Pas.}{to catch sight, a glimpse of} aussitôt\ft[aussitôt]{adv.}{immediately} une lueur\ft[lueur]{n.f.}{glow, light, gleam}, dans le mystère de sa présence, et j'interrogeai\ft[interroger]{v.t.}{to ask, to question} brusquement\ft[brusquement]{adv.}{suddenly}:

-Tu viens donc d'une autre planète?

Mais il ne me répondit pas. Il hochait\ft[hocher la tête]{to}{nod} la tête doucement tout en regardant mon avion:

-C'est vrai que, là-dessus\ft[là-dessus]{adv.}{to here}, tu ne peux pas venir de bien loin\ft[loin]{adv.}{far (away)}...

\incpic{pic/image9.jpeg}

Et il s'enfonça\ft[s'enfoncer dans]{to}{sink into, to disappear into} dans une rêverie\ft[rêverie]{n.f.}{day dreaming} qui dura\ft[durer]{v.i.}{to last} longtemps. Puis, sortant\ft[sortant]{v.t.}{Par.prés. (sortir) to take out} mon mouton de sa poche, il se plongea\ft[se plonger dans]{v.pr.+prép.}{to sink into} dans la contemplation de son trésor\ft[trésor]{n.m.}{treasure}.

Vous imaginez combien j'avais pu être intrigué\ft[intriguer]{v.t.}{to intrigue, to puzzle} par cette demi-confidence sur «~les autres planètes~». Je m'efforçai\ft[s'efforcer de faire qch.]{to}{make effort to do sth. } donc d'en savoir plus long:
...
-Mais si tu ne l'attaches pas, il ira\ft[aller]{v. 3 p.s. Fut.}{} n'importe\ft[n'importe où]{loc.adv.}{anywhere} où, et il se perdra\ft[perdra]{v.pr.i.}{3 p.s. Fut. to lost}...
...
Alors le petit prince remarqua\ft[remarquer]{v.t.}{to notice} gravement:

-Ca ne fait rien, c'est tellement petit, chez moi! 

Et, avec un peu de mélancolie\ft[mélancolie]{n.f.}{melancholy}, peut-être, il ajouta: 
...
Ca ne pouvait pas m'étonner\ft[étonner]{v.t.}{to amaze, to surprise} beaucoup. Je savais bien qu'en dehors\ft[en dehors]{loc.adv.}{outside} des grosses\ft[gros]{adj.}{large, big} planètes comme la Terre, Jupiter, Mars, Vénus, auxquelles on a donné des noms, il y en a des centaines\ft[centaine]{n.f.}{hundred} d'autres qui sont quelque-fois si petites qu'on a beaucoup de mal à les apercevoir au téléscope. Quand un astronome découvre l'une d'elles, il lui donne pour nom un zéro. Il l'appelle par example: «~l'astéroide 3251.~»

J'ai de sérieuses raisons de croire que la planète d'où venait le petit prince est l'astéroide B 612.
...
Heureusement\ft[herersement]{adv.}{luckily}, pour la réputation de l'astéroide B 612 un dictateur turc imposa à son peuple, sous peine de mort, de s'habiller\ft[s'habiller]{v.pr.}{to get dressed, to dress} à l'Européenne. L'astronome refit se démonstration en 1920, dans un habit\ft[habit]{n.m.}{costume, outfit} très élégant. Et cette fois-ci tout le monde fut de son avis.

\incpic{pic/image12.jpeg}

Si je vous ai raconté\ft[raconter]{v.t.}{to tell} ces détails sur l'astéroide B 612 et si je vous ai confié son numéro, c'est à cause des grandes personnes. Les grandes personnes aiment les chiffres. Quand vous leur parlez d'un nouvel ami, elles ne vous questionnent jamais sur l'essentiel. Elles ne vous disent jamais: «~Quel est le son\ft[son]{n.m.}{sound} de sa voix? Quels sont les jeux\ft[jeu]{n.m.}{game} qu'il préfère? Est-ce qu'il collectionne les papillons\ft[papillon]{n.m.}{butterfly}?~» Elles vous demandent: «~Quel âge a-t-il? Combien a-t-il de frères? Combien pèse\ft[péser]{v.i.}{to weight}-t-il? Combien gagne\ft[gagner]{v.t.}{to earn} son père?~» Alors seulement elles croient le connaître. Si vous dites aux grandes personnes: «~J'ai vu une belle maison en briques roses, avec des géraniums aux fenêtres\ft[fenêtre]{n.f.}{window} et des colombes\ft[colonbe]{n.f.}{dove} sur le toit\ft[toit]{n.m.}{roof}...~» Elles ne parviennent\ft[parvienir à]{v. 3 p.p. Prés.}{to achieve} pas à s'imaginer cette maison. Il faut leur dire: «~J'ai vu une maison de cent mille francs.~» Alors elles s'écrient\ft[s'ecrier]{v.pr.i.}{to cry}: «~Comme c'est joli!~»

Ainsi, si vous leur dites: «~La preuve\ft[preuv]{n.f.}{proof} que le petit prince a éxisté c'est qu'il était ravissant\ft[ravissant]{adj.}{gorgeous, beautiful}, et qu'il voulait un mouton. Quand on veut un mouton, c'est la preuve qu'on existe~» Elles hausseront\ft[hausser]{v.t.}{to raiser, to increase, to put up	} les épaules\ft[épaule]{n.f.}{shoulder} et vous traiteront\ft[traiter]{v.t.}{to treat} d'enfant! Mais si vous leur dites: «~La planète d'où il venait est l'astéroide B 612~» alors elles seront convincues, et elles vous laisseront tranquille\ft[tranquille]{adj.}{quiet} avec leurs questions. Elles sont comme ça. Il ne faut pas leur en vouloir. Les enfants doivent être très indulgents\ft[endulgent]{adj.}{lenient, forgiving} envers\ft[envers]{prép.}{towards, to} les grandes personnes.
...
%Car je n'aime pas qu'on lise\ft[lire]{v.t. 3 p.s. Près.subj.}{to read} mon livre à la légère\ft[à la légèr]{loc.adv.}{lightly}, j'éprouve\ft[éprouver]{v.t.}{to feel, to experience} tant de chagrin\ft[chgrin]{n.m.}{sorrow, grief} à raconter ces souvenirs. Il y a six ans déjà que mon ami s'en est allé avec son mouton. Si j'essaie ici de le décrire\ft[deécrire]{v.t.}{to describe}, c'est afin\ft[afin de]{loc.prép.}{so as to, in order to} de ne pas l'oublier. C'est triste\ft[triste]{adj.}{sad} d'oublier un ami. Tout le monde n'a pas eu un ami. Et je puis devenir comme les grandes personnes qui ne s'intéressent plus qu'aux chiffres. C'est donc pour ça encore que j'ai acheté une boîte\ft[boîte]{n.f.}{box} de couleurs et des crayons. C'est dur\ft[dur]{adj.}{hard} de se remettre au dessin, à mon âge, quand on n'a jamais fait d'autres tentatives\ft[tentative]{n.f.}{attempt} que celle d'un boa fermé et celle d'un boa ouvert, à l'âge de six ans! J'essayerais bien sûr, de faire des portraits le plus ressemblants\ft[ressemblant]{adj.}{lifelike} possible. Mais je ne suis pas tout à fait certain de réussir. Un dessin va, et l'autre ne ressemble plus. Je me trompe\ft[se tromper]{v.pr.i.}{make a mistake} un peu aussi sur la taille\ft[taille]{n.f.}{dressing}. Ici le petit prince est trop grand. Là il est trop petit. J'hésite aussi sur la couleur de son costume.

%Alors je tâtonne comme ci et comme ça, tant bien que mal\ft[tant bien que mal]{loc.adv.}{after a fashion, some how}. Je me tromperai\ft[]{Fut.}{} enfin sur certains détails plus importants. Mais ça, il faudra me le pardonner\ft[pardonner]{v.t.}{to forgive}. Mon ami ne donnait jamais d'explications. Il me croyait peut-être\ft[peut-être]{adv.}{maybe, perhaps} semblable\ft[semblable]{adj.}{similar, alike} à lui. Mais moi, malheureusement\ft[malheureusement]{adv.}{unfortunately}, je ne sais pas voir les moutons à travers\ft[à travers]{loc.prép.}{through, across} les caisses. Je suis peut-être un peu comme les grandes personnes. J'ai dû vieillir.

\parachapter[V]{} %Le Chapitre V
\maincol
Chaque\ft[chaque]{dét.}{each} jour j'apprenais quelque chose sur la planète, sur le départ\ft[départ]{n.m.}{departure}, sur le voyage. Ca venait tout doucement, au hasard\ft[au hasard de]{loc.prép.}{je me suis fait des amis au hasard de mes voyages.: I made friends with people I happened to meet on my travels} des réflexions. C'est ainsi que, le troisième jour, je connus le drame\ft[drame]{n.m.}{drama} des baobabs.
\ipacol
ʃak ʒuʁ ʒapʁənɛ kɛlkə ʃoz syʁ la planɛt, syʁ lə depaːʁ, syʁ lə vwajaːʒ. ka vənɛ tu dusmɑ̃, o azaʁ de ʁeflɛksjɔ̃. sɛt- ɛ̃si kə, lə tʁwazjɛm ʒuːʁ, ʒə kɔny lə dʁam de baɔbab.
\maincol
...
-Par conséquent\ft[par conséquent]{loc.adv.}{therefore, consequently} ils mangent aussi les baobabs?

Je fis remarquer\ft[remarquer]{v.t.}{to notice, to remark} au petit prince que les baobabs ne sont pas des arbustes, mais des arbres\ft[arbre]{n.m.}{tree} grand comme des églises\ft[église]{n.f.}{church} et que, si même\ft[même]{adv.}{even} il emportait avec lui tout un troupeau\ft[troupeau]{n.m.}{herd} d'éléphants, ce troupeau ne viendrait pas à bout\ft[bout]{n.m.}{end} d'un seul baobab.

L'idée du troupeau d'éléphants fit rire le petit prince:

-Il faudrait\ft[faudrait]{Cond.}{falloir} les mettre\ft[mettre]{v.t}{put} les uns sur les autres...
...
Et en effet, sur la planète du petit prince, il y avait comme sur toutes les planètes, de bonnes herbes et de mauvaises herbes. Par conséquent de bonnes graines de bonnes herbes et de mauvaises graines de mauvaises herbes. Mais les graines sont invisibles. Elles dorment dans le secrèt de la terre jusqu'à ce qu'il prenne fantaisie à l'une d'elles de se réveiller. Alors elle s'étire\ft[s'étirer]{v.pr.i.}{to stretch}, et pousse\ft[pousser]{v.t.}{to push} d'abord timidement vers le soleil une ravissante\ft[ravissant]{adj.}{gorgeous, beautiful} petite brindille\ft[brindille]{n.f.}{twig} de radis ou de rosier, on peut la laisser pousser comme elle veut. Mais s'il s'agit\ft[agir]{v.t.}{to act, to behave} d'une mauvaise plante, il faut arracher\ft[arracher]{v.t.}{pull} la plante aussitôt, dès\ft[dès que]{loc.prép.}{as soon as, when ever} qu'on a su\ft[savoir]{Part.pas.}{} la reconnaître. Or il y avait des graines terribles sur la planète du petit prince... c'étaient les graines de baobabs. Le sol\ft[sol]{n.m.}{soil} de la planète en était infesté. Or un baobab, si l'on si prend trop tard, on ne peut jamais plus s'en débarrasser\ft[débarrasser]{v.t.}{clear}. Il encombre\ft[encombrer]{v.t.}{to fill} toute la planète. Il la perfore\ft[perforer]{v.t.}{to pierce} de ses racines\ft[racine]{n.f.}{root}. Et si la planète est trop petite, et si les baobabs sont trop nombreux\ft[nombreux]{adj.}{many}, ils la font éclater\ft[éclater]{v.i.}{to explode}.

\incpic{pic/image14.jpeg}

«~C'est une question de discipline, me disait plus tard le petit prince. Quand on a terminé sa toilette du matin, il faut faire soigneusement\ft[soigneusement]{adv.}{neatly, carefully} la toilette de la planète. Il faut s'astreindre\ft[astreindre qun. à faire qch.]{}{to comple sb. to do sth.} réguliérement\ft[réguliérement]{adv.}{steadly} à arracher les baobabs dès\ft[dès que]{loc.}{adv. as soon as} qu'on les distingue d'avec les rosiers auxquels ils se rassemblent beaucoup quand ils sont très jeunes. C'est un travail très ennuyeux\ft[ennuyeux]{adj.}{boring}, mais très facile.~» 

\incpic{pic/image15.jpeg}

Et un jour il me conseilla\ft[conseiller]{v.t.}{to recommend} de m'appliquer\ft[s'appliquer à faire]{}{to try to do} à réussir un beau dessin, pour bien faire entrer ça dans la tête des enfants de chez moi. «~S'ils voyagent un jour, me disait-il, ça pourra leur servir. Il est quelquefois sans inconvénient de remettre à plus tard son travail. Mais, s'il s'agit des baobabs, c'est toujours une catastrophe\ft[catastrophe]{n.f.}{disaster}. J'ai connu une planète, habitée par un paresseux\ft[parseux]{n.m.}{lazy man}. Il avait négligé trois arbustes...~»

Et, sur les indications du petit prince, j'ai dessiné cette planète-là. Je n'aime guère prendre le ton\ft[ton]{n.m.}{tone} d'un moraliste\ft[moraliste]{n.m.}{moralist}. Mais le danger des baobabs est si peu connu, et les risques courus par celui qui s'égarerait dans un astéroïde sont si considérables, que, pour une fois, je fais exception à ma réserve. Je dis: «~Enfants! Faites attention aux baobabs!~» C'est pour avertir\ft[avertir]{v.t.}{to inform, to warn} mes amis du danger qu'ils frôlaient depuis longtemps, comme moi-même, sans le connaître, que j'ai tant travaillé ce dessin-là. La leçon que je donnais en valait\ft[valoir]{v.t. 3 p.s. Impar.}{to be worth} la peine. Vous vous demanderez peut-être: Pourquoi n'y a-t-il pas dans ce livre, d'autres dessins aussi grandioses que le dessin des baobabs? La réponse est bien simple: J'ai essayé mais je n'ai pas pu réussir. Quand j'ai dessiné les baobabs j'ai été animé\ft[animer]{v.t.}{to motivate} par le sentiment\ft[sentiment]{n.m.}{feeling} de l'urgence.

\parachapter[VI]{} %Le Chaptre VI
Ah! Petit prince, j'ai compris, peu à peu, ainsi, ta petite vie mélancolique. Tu n'avais eu longtemps pour ta distraction que la douceur des couchers du soleil. J'ai appris ce détail nouveau\ft[nouveau]{adj.}{new}, le quatrième jour au matin, quand tu m'as dit:
...
Tu as eu l'air\ft[air]{n.m.}{air, look} très surpris d'abord, et puis tu as ri de toi-même. Et tu m'as dit:

-Je me crois toujours chez moi!

En effet. Quand il est midi aux Etats-Unis, le soleil, tout le monde sait, se couche sur la France. Il suffirait\ft[suffire]{v.i. 3 p.s. Cond.}{to be enough, to be sufficient, to suffice} de pouvoir aller en France en une minute pour assister\ft[assister à]{v.+prép.}{to attend, to witness} au coucher de soleil. Malheureusement la France est bien trop éloignée\ft[éloigné]{adj.}{distant, remote, faraway}. Mais, sur ta si petite planète, il te suffirait de tirer\ft[tirer]{v.t.}{to pull, to drag} ta chaise de quelques pas\ft[pas]{n.m.}{step}. Et tu regardais le crépuscule\ft[crépuscule]{n.m.}{twilight} chaque fois que tu le désirais\ft[désirer]{v.t.}{to wish for}...

-Un jour, j'ai vu le soleil se coucher quarante-trois fois!

Et un peu plus tard tu ajoutais:

-Tu sais... quand on est tellement triste\ft[triste]{adj.}{sad} on aime les couchers de soleil...
...
Je ne le savais pas. J'étais alors très occupé à essayer de dévisser\ft[dévisser]{v.t.}{loosen} un boulon trop serré\ft[serré]{adj.}{tight} de mon moteur. J'étais très soucieux\ft[soucieux]{adj.}{worried} car ma panne\ft[panne]{n.f.}{break down} commençait de m'apparaître comme très grave, et l'eau à boire qui s'épuisait\ft[épuiser]{v.t.}{to exhaust} me faisait craindre\ft[craindre]{v.t.}{to fear} le pire\ft[le pire]{the}{worst}.
